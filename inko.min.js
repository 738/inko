  ...
  function a(n) {
    ...
    return (
      (this._allowDoubleConsonant =
        void 0 !== e.allowDoubleConsonant && e.allowDoubleConsonant),
      this
    );
  }
  (a.prototype.config = function (n) {
    var e = n || {};
    this._allowDoubleConsonant =
      void 0 !== e.allowDoubleConsonant && e.allowDoubleConsonant;
  }),
    (a.prototype.VERSION = '1.1.1'),
    (a.prototype.en2ko = function (n, d) {
      var r = d || {},
        a =
          void 0 !== r.allowDoubleConsonant
            ? r.allowDoubleConsonant
            : this._allowDoubleConsonant,
        l = this,
        p = [0, 1, 1, 2, 2, 2, 3, 3, 4, 4, 5],
        s = [
          [1, 1, 2, 2],
          [3, 1, 4, 4],
          [1, 1, 5, 2],
        ...
        c = function (n) {
          ...
          if (
            (n.forEach(function (n, i) {
              var f = e[n];
              (0 !== i && u(h(d)[0]) === u(f)) || d.push([]), h(d).push(f);
            }),
            1 ===
              (d = d.map(function (n) {
                var e = n.join('');
            ...
            return d[0];
          var t = [i, f, o],
            r = d.map(function (n, e) {
              return t[e].indexOf(n);
            });
          return r.length < 3 && r.push(-1), l.한글생성.apply(l, r);
        };
      return (function () {
        for (
          var i,
          ...
          if (void 0 === g) (l = 0), v(), r.push(y);
            ...
            h.push(g);
            var m = h.length - p[b];
            m && r.push(c(h.splice(0, m))), (l = b), (d = g);
          }
        }
        return v(), r.join('');
      })();
    }),
    (a.prototype.ko2en = function (e) {
      var i = '';
    ...
    (a.prototype.한글생성 = function (n, e, i) {
      return String.fromCharCode(44032 + 588 * n + 28 * e + i + 1);
    }),
    (a.prototype.한글분리 = function (n) {
      var t = n.charCodeAt();
      if (t >= d && t <= 55203) {
    ...
    (a.prototype.is한글 = function (n) {
      if (n.length > 1) throw new Error('한 글자가 아닙니다.');
      return /[ㄱ-ㅎ|ㅏ-ㅣ|가-힣]/.test(n);
    }),
    ...
    'undefined' != typeof importScripts && ((inko = new a()), (self.Inko = a)),
    'object' == typeof window &&
      'object' == typeof window.document &&
      ((window.Inko = a), (window.inko = new a()));
})();
